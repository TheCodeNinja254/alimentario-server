...
class AuthenticationSessions extends RESTDataSource {
  async getSignedInCustomer() {
    ...
    const loggedInUsername = this.context.session && this.context.session.customerDetails
    && this.context.session.customerDetails.username ? this.context.session.customerDetails.username : undefined;
    ...
    const bearerToken = this.context.session.customerDetails.bearerToken || undefined;
  ...
  async getSignedInUser() {
    ...
    const loggedInUsername = this.context.session && this.context.session.userDetails
    && this.context.session.userDetails.username ? this.context.session.userDetails.username : undefined;
    ...
    const bearerToken = this.context.session.userDetails.bearerToken || undefined;
